    ...
    <div class="container-fluid">
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a style="padding-top:0px" href="?page=home"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Beranda</a></li>
                <li><a style="padding-top:0px" href="system/logout.php"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Keluar</a></li>
            </ul>
        </div>
    </div>
</nav>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-brand">
                    <a href="#" class="navbar-brand" style="margin-right:10px;border:none">
                        <span aria-hidden="true" style="font-size: 20px"> </span> <?php echo $_SESSION['admin'] ?>
                    </a>
                </li>
                <li>
